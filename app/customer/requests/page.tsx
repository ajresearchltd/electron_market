...
const customerPayload=(payload:Record<string,unknown>|null)=>Object.fromEntries(Object.entries(payload??{}).filter(([key])=>!['requestedSupplierId','publicSupplierSlug'].includes(key)));
